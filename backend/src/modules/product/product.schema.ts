...
export const updateProductSchema = z.object({
  body: z.object({
    ...
    image1kg: z.preprocess((v) => (v === '' ? null : v), z.string().nullable().optional()),
    price1kg: z.number().positive().optional(),
    image3kg: z.preprocess((v) => (v === '' ? null : v), z.string().nullable().optional()),
    price3kg: z.number().positive().optional(),
    image5kg: z.preprocess((v) => (v === '' ? null : v), z.string().nullable().optional()),
    price5kg: z.number().positive().optional(),
    galleryImages: z.array(z.string()).optional(),
    benefits: z.array(z.string()).optional(),
    sku: z.preprocess((v) => (v === '' ? undefined : v), z.string().optional()),
