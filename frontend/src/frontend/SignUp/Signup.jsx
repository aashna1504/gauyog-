...
export default function ModernSignUp() {
  ...
  const handleGoogleSuccess = async (response) => {
    if (!response.credential) { toast.error("Google signup failed"); return; }
    try {
        ...
        >
          ...
          <div className="m-8 lg:mt-20">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-[900] text-slate-900 tracking-tighter">Create account</h1>
            </div>
            <p className="text-sm text-slate-400 font-medium ml-[52px]">Join us — it only takes a minute</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSignUp}>
            ...
            <div className="space-y-1.5 group">
              ...
              <div className="relative">
                ...
                />
                <User className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-[#744926] transition-colors" size={16} />
              </div>
            </div>
            ...
            <div className="space-y-1.5 group">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 px-5 py-3.5 rounded-2xl text-sm font-semibold text-slate-900 outline-none focus:bg-white focus:border-[#744926] focus:ring-4 focus:ring-[#744926]/10 transition-all"
                />
                <Mail className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-[#744926] transition-colors" size={16} />
              </div>
            </div>
              ...
              <div className="space-y-1.5 group">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 px-5 py-3.5 rounded-2xl text-sm font-semibold text-slate-900 outline-none focus:bg-white focus:border-[#744926] focus:ring-4 focus:ring-[#744926]/10 transition-all"
                  />
                  <Lock className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-[#744926] transition-colors" size={15} />
                </div>
              </div>
            </div>
