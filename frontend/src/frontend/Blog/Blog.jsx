...
const categories = ["All", "Organic Farming", "Natural Fertilizer", "Ayurvedic Benefits", "Cow-Based Products"];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {blogPosts.slice(1).map((post, i) => (
              ...
              >
                <Link
                  to={`/blog/${post.slug}`}
                  className="group block bg-white rounded-3xl overflow-hidden shadow-md shadow-[#4a703f]/5 border border-slate-100 hover:shadow-xl hover:shadow-[#4a703f]/10 transition-all duration-300 h-full flex flex-col"
                >
