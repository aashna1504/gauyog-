...
import { Quote, Star, ArrowUp, ArrowDown, CheckCircle2, SmileIcon } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 md:gap-20 items-center">
        ...
        <div className="flex flex-col">
          ...
          <h2 className="text-4xl md:text-7xl font-bold text-gray-900 leading-tight mb-4 md:mb-8">
            The <span className="text-[#7bbd25] italic underline decoration-[#7bbd25] underline-offset-4 md:underline-offset-8">Trust</span> <br /> 
            we've earned.
          </h2>
          ...
          <div className="flex items-center gap-4 mb-6 md:mb-12">
            ...
            <span className="text-xs md:text-sm font-black text-gray-400">0{index + 1} / 0{testimonials.length}</span>
          </div>
                  ...
                  <div className="pt-4 md:pt-8 border-t border-gray-100 flex items-center justify-between">
                    <div>
                      <p className="text-lg md:text-xl font-black text-gray-900 flex items-center gap-2">
                        ...
                        <CheckCircle2 size={14} md={16} className="text-[#7bbd25]" />
                      </p>
                    ...
                    <div className="flex gap-0.5 md:gap-1">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} size={12} md={14} className="fill-yellow-400 text-yellow-400" />
                      ))}
                    </div>
                  </div>
                </div>
